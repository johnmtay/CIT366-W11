...
export class MessagesService {
    ...
    storeMessages() {
        ...
        return this.http.put('https://rkjcms-5f40d.firebaseio.com/messages.json', this.messages, { headers: header})
          .subscribe(
            (messages: Message[]) => {
      ...
      getMessages() {
        this.http.get('https://rkjcms-5f40d.firebaseio.com/messages.json')
          .subscribe(
            (messages: Message[]) => {
